...
<head>
    ...
    <style>
        ...
        .display { font-size: 35px; background: #000; padding: 20px; border-radius: 15px; margin: 15px 0; border: 2px solid #333; }
        ...
        #status { font-size: 11px; margin-bottom: 10px; color: #888; word-break: break-all; }
    </style>
</head>
<body>
    <div class="machine">
    ...
    <script>
        ...
        async function connect() {
            ...
            } else { tg.showAlert("Please open this inside Brave or Phantom browser!"); }
        }
        ...
        async function play() {
            try {
                ...
                document.getElementById('log').innerText = "CONFIRMING...";
                
                setTimeout(() => {
                    document.getElementById('slot').innerText = "🦎 | 🦎 | 🦎";
                    tg.showAlert("JACKPOT! Payment confirmed.");
                    document.getElementById('spinBtn').disabled = false;
                }, 3000);
            } catch (err) { tg.showAlert("Transaction failed or canceled"); }
        }
    </script>
</body>
</html>
